...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, TranslateModule, FormsModule, CardModule, ButtonModule],
  ...
  providers: InsuranceProvider[] = [
    {
      ...
      themeColor: '#0079C8',
      portalUrl: 'https://www.bupa.com.eg/',
    ...
    },
    {
      ...
      themeColor: '#0090DA',
      portalUrl: 'https://www.metlife.com.eg/',
    ...
    },
    {
      ...
      themeColor: '#003781',
      portalUrl: 'https://www.allianz.com.eg/',
